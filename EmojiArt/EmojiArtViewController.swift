...
//  EmojiArt
//
//  Created by Jiale Duan on 2019-06-26.
//  Copyright © 2019 Jiale Duan. All rights reserved.
//
...
UICollectionViewDelegateFlowLayout, UICollectionViewDragDelegate, UICollectionViewDropDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        for item in coordinator.items {
            // Dragging and dropping from inside the app
            if let sourceIndexPath = item.sourceIndexPath {
                ...
                // Dragging and dropping from another app
